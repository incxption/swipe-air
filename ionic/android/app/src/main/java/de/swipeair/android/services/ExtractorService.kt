...
import de.swipeair.android.client.Client
import de.swipeair.android.client.YouTubeVideoPacket

private const val TAG = "SwipeAir-Extractor"

class ExtractorService : AccessibilityService() {

    companion object {
        var instance: ExtractorService? = null
            private set
    }
